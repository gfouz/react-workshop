...
`,be=`S\xE9 que para gustos los colores, pero en mi caso he podido 
          ...
          forma continua.
`,ye=()=>e(d,{children:e(ve,{children:e("article",{className:"l-flex",children:n("div",{className:"outlook",children:[e("h4",{className:"outlook__topic",children:"Mi perspectiva personal"}),e("img",{src:"./images/lamp.svg",alt:"developer",className:"outlook__image"}),e("p",{className:"outlook__text",children:be})]})})})}),ve=c.div`
     display: grid;
     place-items: center;
     margin: 2em 0;
   .l-flex {
...
`,_e=c.div`
  ...
  ${a=>a.primary&&w`
    ...
    `}
`;function S(a){const t=["/about","/work","/blog","/"],r=G(),{pathname:s}=r,o=t.filter(i=>i!==s);return e(d,{children:e(_e,{color:a.color,bg:a.bg,fontFamily:a.font,position:a.position,height:a.height,margin:a.margin,logo:a.logo,children:n("div",{className:"links",children:[e("div",{className:"logo",children:a.children}),o.map((i,l)=>e("div",{children:e(b,{className:"links__item",to:`${i}`,children:i==="/"?"home":i.slice(1)})},i+l))]})})})}const xe=W(a=>({l_grid:{margin:"1em 0",display:"flex",flexDirection:"column",alignItems:"center",padding:"2em 0"},avatar:{margin:a.spacing(2),backgroundColor:a.palette.secondary.main},form:{width:"100%",marginTop:a.spacing(1)},form__input:{display:"flex",flexDirection:"column",alignItems:"center"},warnings:{color:"#c51162",textTransform:"uppercase",fontSize:"10px"},formHide:{display:"none"},submit:{display:"block",margin:"2em auto"}})),we=()=>{g.exports.useState("");const a=xe(),{control:t}=B({defaultValues:{email:"",message:""}});return e(M,{children:n("div",{className:a.l_grid,children:[e(U,{className:a.avatar,children:e(Y,{})}),e(Z,{component:"h1",variant:"h6",children:"Contact me"}),n("form",{className:"form",action:"https://formspree.io/f/mbjwalqp",method:"post",children:[e(R,{name:"email",control:t,rules:{pattern:/^[A-Z0-9._%+-]+@[A-Z0-9.-]+\.[A-Z]{2,}$/i,required:!0},render:({field:r,formState:{errors:s,isSubmitted:o}})=>{var i,l;return n("div",{className:a.form__input,children:[e($,x(f({},r),{variant:"outlined",margin:"normal",label:"Email",color:s.email?"secondary":"primary"})),((i=s.email)==null?void 0:i.type)==="pattern"&&e("span",{className:a.warnings,children:"email includes an @ symbol !"}),((l=s.email)==null?void 0:l.type)==="required"&&e("span",{className:a.warnings,children:"email is required !"})]})}}),e(R,{name:"message",control:t,rules:{required:!0},render:({field:r,formState:{errors:s,isSubmitted:o}})=>{var i;return n("div",{className:a.form__input,children:[e($,x(f({},r),{variant:"outlined",margin:"normal",label:"Message",color:s.message?"secondary":"primary"})),((i=s.message)==null?void 0:i.type)==="required"&&e("span",{className:a.warnings,children:"This field must not be empty !"})]})}}),e(K,{type:"submit",variant:"contained",color:"secondary",className:a.submit,children:"Submit"})]})]})})},ke=()=>e(d,{children:e(j,{theme:I,children:e(Ne,{children:n("div",{className:"l-grid",children:[e(S,{bg:"#f0f0f0",color:"#000000"}),e(ge,{}),e(pe,{}),e(ye,{}),e(we,{}),e("footer",{className:"l-grid__footer",children:n("h4",{className:"l-grid__title",children:["Gfouz \xA9 ",new Date().getFullYear()," Made with ReactJs"]})})]})})})}),Ne=c.div`
  background-color: #f0f0f0; 
  .l-grid {
    min-height: 100vh;
...
`,ze=`
  ...
  favourite choosing.
`,z=[{title:"Constantes de JavaScript",paragraph:Se},{title:"Composici\xF3n funcional",paragraph:Ce},{title:"introduction",paragraph:ze}],k={fontSize:"30px",color:"#455a64"},Te=[{icon:e(V,{style:k}),url:"https://github.com/gfouz",name:"github"},{icon:e(Q,{style:k}),url:"//https://api.whatsapp.com/send?phone=+5354278815",name:"telegram"},{icon:e(X,{style:k}),url:"https://github.com/gfouz",name:"email"},{icon:e(ee,{style:k}),url:"//https://api.whatsapp.com/send?phone=+5354278815",name:"whatsapp"}],Ie=a=>e(d,{children:e(qe,{height:a.height,children:e("nav",{className:"navbar",children:e("ul",{className:"navbar__list",children:Te.map((t,r)=>e("li",{className:"navbar__item",children:e("a",{href:t.url,className:"navbar__link",children:t.icon})},r))})})})}),qe=c.div`
  .navbar {
...
`}];function Ae(){return e(d,{children:e(Ee,{children:e("div",{className:"postlist",children:n("div",{className:"posts",children:[e("h3",{className:"posts__topic",children:"you might interest"}),N.length&&N.map((a,t)=>n("div",{className:"posts__card",children:[e("img",{className:"posts__image",src:`./images/${a.img}`,alt:"post"}),n("div",{className:"posts__card-text",children:[e("h4",{className:"posts__title",children:a.title}),n("small",{className:"posts__info",children:["Published on: ",a.date," by ",a.author]}),e("p",{className:"posts__description",children:a.description}),e(b,{className:"posts__link",to:`/post/${a.id}`,children:"Read More"})]})]},a.id))]})})})})}const Ee=c.div`
 height: 100%;
 --violet: #820aa1;
 --blue: #3f8897;
 --black: #444444;
...
`;function Re(){return e(d,{children:e($e,{children:n("div",{className:"l-blog",children:[e(S,{bg:"#25180c",color:"#ffffff"}),n("section",{className:"blog",children:[e("div",{className:"blog__image",children:e("h1",{className:"blog__title",children:"Let's be inquisitive as children."})}),e("article",{className:"blog__posts",children:e(Ae,{})})]}),e("footer",{className:"blog-footer",children:n("h3",{children:["gfouz \xA9 ",new Date().getFullYear()," made with react"]})})]})})})}const $e=c.div`
  --violet: #820aa1;
  --grey: #222222;
  --blue: #3f8897;
  --brown: #25180c;
...
`,De=a=>{const t=D(),r=ae(),s=parseInt(t.id),o=a.posts.map(p=>p.id),i=o.indexOf(s),[l,h]=g.exports.useState(!0),[m,C]=g.exports.useState(i);g.exports.useEffect(()=>{r(`/post/${o[m]}`)},[m]);function y(){m<o.length-1?C(p=>p+1):h(!1),m===o.length-1?h(!1):h(!0)}function v(){m>0?C(p=>p-1):r("/blog"),h(!0)}return e(d,{children:e(Le,{color:a.color,children:n("section",{className:"navigate",children:[e("nav",{className:"navigate__prev",children:e("button",{className:"btn btn-back",onClick:v,children:"PREV"})}),e("nav",{className:"navigate__next",children:e("button",{className:l?"btn":"btn  btn--disabled",onClick:y,children:"NEXT"})})]})})})},Le=c.div`
  --violet: #820aa1;
  --blue: #3f8897;
  .navigate {
    margin: 2em 0;
...
`;function Oe(){const a={},t=D(),r=parseInt(t.id);N.forEach((o,i)=>{r===o.id&&(a.content=o.content?o.content:"no given content",a.id=o.id?o.id:"no given id",a.img=o.img?o.img:"no give data",a.position=o.position?o.position:"no given position")});const s={backgroundImage:`url(./images/${a.img})`,backgroundRepeat:"no-repeat",backgroundSize:"cover",backgroundPosition:a.position,height:"400px"};return e(d,{children:e(He,{children:e("div",{className:"l-post",children:n("section",{className:"post",children:[e(S,{bg:"#25180c",color:"#ffffff"}),e("div",{className:"post__image",style:s}),e(ne,{id:a.id,className:"post__markdown",children:a.content,components:{code(C){var y=C,{node:o,inline:i,className:l,children:h}=y,m=E(y,["node","inline","className","children"]);const v=/language-(\w+)/.exec(l||"");return!i&&v?e(te,f({children:String(h).replace(/\n$/,""),style:oe,language:v[1],PreTag:"div"},m)):e("code",x(f({className:l},m),{children:h}))}}}),e(De,{posts:N})]})})})})}const He=c.div`
  .l-post {
    margin: 0 auto;
...
`,Je=()=>e(d,{children:e(Pe,{children:e("h1",{children:"the page you are looking for does not exist"})})}),Pe=c.div`
 

`;re.render(e(ie.StrictMode,{children:e(d,{children:n(j,{theme:I,children:[e(L,{}),e(se,{children:n(le,{children:[e(u,{path:"/",element:e(me,{})}),e(u,{path:"/about",element:e(Fe,{})}),e(u,{path:"/work",element:e(ke,{})}),e(u,{path:"/blog",element:e(Re,{})}),e(u,{path:"/404",element:e(Je,{})}),e(u,{path:"/post/:id",element:e(Oe,{})})]})})]})})}),document.getElementById("root"));
